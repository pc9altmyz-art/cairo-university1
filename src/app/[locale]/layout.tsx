...
export const metadata: Metadata = {
  title: "المؤسسه المصريه للاستشارات العلمية والتربوية - برامج تدريبية معتمدة",
  description: "المؤسسه المصريه للاستشارات العلمية والتربوية - برامج تدريبية معتمدة بالتعاون مع كلية التربية النوعية جامعة عين شمس",
  keywords: ["المؤسسه المصريه", "استشارات علمية", "برامج تدريبية", "شهادات معتمدة", "جامعة عين شمس", "التربية النوعية"],
  authors: [{ name: "المؤسسه المصريه للاستشارات العلمية والتربوية" }],
  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
    title: "المؤسسه المصريه للاستشارات العلمية والتربوية",
