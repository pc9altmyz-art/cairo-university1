                            ...
                            <div className="premium-glass bg-white dark:bg-[#0F172A]/40 rounded-[3rem] p-8 md:p-10 shadow-2xl border border-slate-200 dark:border-white/10 sticky top-32">
                                ...
                                <div className="space-y-6">
                                    <Link
                                        ...
                                        target="_blank"
                                        className="flex items-center justify-center gap-4 w-full bg-[#1e3a8a] hover:bg-[#D4A853] text-white hover:text-[#172554] py-5 rounded-[2rem] font-black text-xs md:text-sm uppercase tracking-widest transition-all shadow-xl shadow-blue-900/20 hover:-translate-y-1 border border-white/10 group"
                                    >
                                        <div className="bg-[#25D366] p-1.5 rounded-full shadow-lg group-hover:scale-110 transition-transform">
