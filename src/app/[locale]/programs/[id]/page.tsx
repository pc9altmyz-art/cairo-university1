            ...
            <div className="min-h-screen bg-slate-50 dark:bg-[#0F172A] pt-32 pb-24 relative overflow-hidden transition-colors duration-500">
                ...
                <div className="container mx-auto px-4 relative z-10">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
                        <Link
                            href="/programs"
                            className="inline-flex items-center gap-3 text-slate-500 dark:text-slate-400 hover:text-[#D4A853] transition-all group bg-white dark:bg-white/5 px-6 py-2.5 rounded-2xl border border-slate-200 dark:border-white/10 backdrop-blur-xl w-fit shadow-sm touch-action-manipulation active:scale-95"
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 transform transition-transform group-hover:-translate-x-1 rtl:group-hover:translate-x-1 pointer-events-none" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
                            </svg>
                            <span className="font-black text-sm uppercase tracking-widest pointer-events-none">{td('back')}</span>
                        </Link>
                        ...
                        <nav className="flex items-center gap-3 text-[10px] font-black uppercase tracking-[0.2em] text-slate-500 overflow-x-auto whitespace-nowrap">
                            <Link href="/" className="hover:text-[#D4A853] transition-colors touch-action-manipulation px-2 -mx-2">{td('breadcrumb_home')}</Link>
                            <span className="opacity-30">/</span>
                            <Link href="/programs" className="hover:text-[#D4A853] transition-colors touch-action-manipulation px-2 -mx-2">{td('breadcrumb_programs')}</Link>
                            <span className="opacity-30">/</span>
                            ...
                            <div className="premium-glass bg-white dark:bg-[#0F172A]/40 rounded-[3rem] p-8 md:p-10 shadow-2xl border border-slate-200 dark:border-white/10 sticky top-32">
                                ...
                                <div className="space-y-6 md:space-y-8 mb-10 md:mb-12">
                                    <div className="flex items-center gap-6 group">
                                        <div className="w-12 h-12 md:w-14 md:h-14 bg-slate-50 dark:bg-white/5 rounded-2xl flex items-center justify-center text-2xl md:text-3xl transition-transform group-hover:scale-110 group-hover:bg-[#1e3a8a]/10 border border-slate-100 dark:border-white/5 shadow-sm">⏳</div>
                                        <div>
                                    ...
                                    <div className="flex items-center gap-6 group">
                                        <div className="w-12 h-12 md:w-14 md:h-14 bg-slate-50 dark:bg-white/5 rounded-2xl flex items-center justify-center text-2xl md:text-3xl transition-transform group-hover:scale-110 group-hover:bg-[#D4A853]/10 border border-slate-100 dark:border-white/5 shadow-sm">💳</div>
                                        <div>
                                ...
                                <div className="space-y-6">
                                    <Link
                                        ...
                                        target="_blank"
                                        className="flex items-center justify-center gap-4 w-full bg-[#1e3a8a] dark:bg-blue-600 hover:bg-[#D4A853] text-white hover:text-[#172554] py-5 rounded-[2rem] font-black text-xs md:text-sm uppercase tracking-widest transition-all shadow-xl shadow-blue-900/20 hover:-translate-y-1 border border-white/10 group touch-action-manipulation"
                                    >
                                        <div className="bg-[#25D366] p-1.5 rounded-full shadow-lg group-hover:scale-110 transition-transform pointer-events-none">
                                        ...
                                        <span className="pointer-events-none">{td('btn_whatsapp')}</span>
                                    </Link>
                                    <Link
                                        href="/#contact"
                                        className="block w-full bg-white dark:bg-white/5 hover:bg-[#D4A853] text-[#1e3a8a] dark:text-[#D4A853] text-center py-5 rounded-[2rem] font-black text-[11px] md:text-sm uppercase tracking-[0.2em] transition-all shadow-lg hover:text-[#172554] hover:-translate-y-1 border border-slate-200 dark:border-white/10 touch-action-manipulation"
                                    >
                                        <span className="pointer-events-none">{td('btn_register')}</span>
                                    </Link>
                                </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                                {relatedPrograms.map((p) => (
                                    <Link
                                        key={p.id}
                                        href={`/programs/${p.id}`}
                                        className="group bg-white dark:premium-glass rounded-[2rem] overflow-hidden border border-slate-200 dark:border-white/5 hover:border-[#D4A853]/30 transition-all duration-500 hover:-translate-y-2 flex flex-col shadow-sm hover:shadow-xl touch-action-manipulation"
                                    >
