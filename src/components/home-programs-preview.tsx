                        ...
                        {featuredPrograms.map((program: Program) => (
                            <TiltCard key={program.id} intensity={8}>
                                <Link
                                    ...
                                    className="bg-white dark:bg-[#0F172A] md:dark:bg-[#0F172A]/80 md:backdrop-blur-3xl rounded-[2.5rem] overflow-hidden shadow-2xl border border-white/10 group hover:shadow-[0_40px_80px_-20px_rgba(30,58,138,0.3)] hover:border-[#D4A853]/40 transition-all duration-700 transform-gpu hover:-translate-y-4 flex flex-col h-full relative touch-action-manipulation"
                                >
