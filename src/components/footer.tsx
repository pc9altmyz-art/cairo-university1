...
export default function Footer() {
    ...
    const instagramLinks = [
        { href: "https://www.instagram.com/ainshams.university.programs", label: lt('instagram') }
    ];
                ...
                <div className="grid md:grid-cols-4 gap-12 mb-16">
                    ...
                    <div>
                        ...
                        <div className="space-y-3 text-sm">
                            ...
                            <Link href="/links" className="block transition-all duration-300 rtl:hover:-translate-x-2 ltr:hover:translate-x-2 hover:text-[#D4A853] hover:drop-shadow-[0_0_10px_rgba(212,168,83,0.5)]" style={{ color: 'var(--dark-section-text-muted)' }}>
                                {lt('title')}
                            </Link>
                    ...
                    <div>
                        ...
                        <div className="space-y-4">
                            ...
                            <Link
                                ...
                                target="_blank"
                                className="flex items-center gap-4 hover:text-[#25D366] transition-colors group h-12" style={{ color: 'var(--dark-section-text-muted)' }}
                            >
                                ...
                                <span className="text-sm font-medium tracking-wide">{t('social_wa')}</span>
                            </Link>
                            ...
                            <div className="flex items-center gap-3 pt-2" style={{ color: 'var(--dark-section-text-muted)' }}>
                                <div className="w-10 h-10 rounded-full flex items-center justify-center shrink-0" style={{ background: 'var(--dark-section-card-bg)', border: '1px solid var(--dark-section-border)' }}>
                                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                                    </svg>
                                </div>
                                <span className="text-xs">{t('univ_name')}</span>
                            </div>
                        </div>
                    </div>
                </div>
