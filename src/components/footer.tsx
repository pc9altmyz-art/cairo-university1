...
export default function Footer() {
    ...
    const premiumColors = ["#D4A853", "#FFFFFF", "#1e3a8a", "#FFD700", "#F4F4F4"];
    ...
    const instagramLinks = [
        { href: "https://www.instagram.com/ainshams.univ.programs", label: lt('instagram') + " (1)" },
        { href: "https://www.instagram.com/ainshams.teachers.programs", label: lt('instagram') + " (2)" },
        { href: "https://www.instagram.com/ainshams.university.programs", label: lt('instagram') + " (3)" }
    ];
        ...
        <footer className="py-24 relative overflow-hidden border-t" style={{ background: 'var(--dark-section-bg)', color: 'var(--dark-section-text)', borderColor: 'rgba(30, 58, 138, 0.2)' }}>
            ...
            <div className="container mx-auto relative z-10">
                <div className="grid md:grid-cols-4 gap-10 mb-12">
                    ...
                    {/* Quick Links */}
                    <div>
                        <div className="font-bold mb-4 text-lg relative inline-block rtl:ml-auto ltr:mr-auto" style={{ color: 'var(--dark-section-text)' }}>
                            {t('links_title')}
                        ...
                        <div className="space-y-3 text-sm">
                            <Link href="/programs" className="block transition-all duration-300 rtl:hover:-translate-x-2 ltr:hover:translate-x-2 hover:text-[#D4A853] hover:drop-shadow-[0_0_10px_rgba(212,168,83,0.5)]" style={{ color: 'var(--dark-section-text-muted)' }}>
                                {t('link_programs')}
                            </Link>
                            <Link href="/#about" className="block transition-all duration-300 rtl:hover:-translate-x-2 ltr:hover:translate-x-2 hover:text-[#D4A853] hover:drop-shadow-[0_0_10px_rgba(212,168,83,0.5)]" style={{ color: 'var(--dark-section-text-muted)' }}>
                                {t('link_about')}
                            </Link>
                            <Link href="/#contact" className="block transition-all duration-300 rtl:hover:-translate-x-2 ltr:hover:translate-x-2 hover:text-[#D4A853] hover:drop-shadow-[0_0_10px_rgba(212,168,83,0.5)]" style={{ color: 'var(--dark-section-text-muted)' }}>
                                {t('link_contact')}
                            </Link>
                        </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-2">
                                <button
                                    ...
                                    className="flex items-center gap-4 hover:text-[#1877F2] transition-colors group w-full text-right rtl:text-right ltr:text-left" style={{ color: 'var(--dark-section-text-muted)' }}
                                >
                                    <div className="w-12 h-12 rounded-2xl group-hover:bg-[#1877F2]/20 group-hover:border-[#1877F2]/50 group-hover:shadow-[0_0_20px_rgba(24,119,242,0.4)] flex items-center justify-center transition-all duration-500 group-hover:-translate-y-1 relative" style={{ background: 'var(--dark-section-card-bg)', border: '1px solid var(--dark-section-border)' }}>
                                        <span className="absolute -top-1 -right-1 text-[8px] text-[#D4A853] opacity-40 group-hover:opacity-100 transition-opacity">🌙</span>
                                    ...
                                    <div className="flex-1 flex items-center justify-between">
                                        ...
                                        <svg className={`w-4 h-4 transition-transform duration-300 ${expandedSocial === 'facebook' ? 'rotate-180' : ''}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                                        </svg>
                                    </div>
                                </button>
                                
                                <div className={`overflow-hidden transition-all duration-300 bg-white/5 rounded-xl ${expandedSocial === 'facebook' ? 'max-h-60 py-2 border border-white/10' : 'max-h-0'}`}>
                                    {facebookLinks.map((link, idx) => (
                                        <a key={idx} href={link.href} target="_blank" rel="noopener noreferrer" className="block px-4 py-2 text-xs hover:text-[#D4A853] hover:bg-white/5 transition-colors">
                                            {link.label}
                                        </a>
                                    ))}
                                </div>
                            ...
                            <div className="space-y-2">
                                <button
                                    ...
                                    className="flex items-center gap-4 hover:text-[#E4405F] transition-colors group w-full text-right rtl:text-right ltr:text-left" style={{ color: 'var(--dark-section-text-muted)' }}
                                >
                                    ...
                                    <div className="flex-1 flex items-center justify-between">
                                        ...
                                        <svg className={`w-4 h-4 transition-transform duration-300 ${expandedSocial === 'instagram' ? 'rotate-180' : ''}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                                        </svg>
                                    </div>
                                </button>

                                <div className={`overflow-hidden transition-all duration-300 bg-white/5 rounded-xl ${expandedSocial === 'instagram' ? 'max-h-60 py-2 border border-white/10' : 'max-h-0'}`}>
                            ...
                            <Link
                                ...
                                target="_blank"
                                className="flex items-center gap-4 hover:text-[#25D366] transition-colors group" style={{ color: 'var(--dark-section-text-muted)' }}
                            >
                                <div className="w-12 h-12 rounded-2xl group-hover:bg-[#25D366]/20 group-hover:border-[#25D366]/50 group-hover:shadow-[0_0_20px_rgba(37,211,102,0.4)] flex items-center justify-center transition-all duration-500 group-hover:-translate-y-1" style={{ background: 'var(--dark-section-card-bg)', border: '1px solid var(--dark-section-border)' }}>
                                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <a
                                ...
                                className="flex items-center gap-4 hover:text-[#D4A853] transition-colors group" style={{ color: 'var(--dark-section-text-muted)' }}
                            >
                            ...
                            <div className="flex items-center gap-3" style={{ color: 'var(--dark-section-text-muted)' }}>
                                <div className="w-10 h-10 rounded-full flex items-center justify-center" style={{ background: 'var(--dark-section-card-bg)' }}>
                                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
