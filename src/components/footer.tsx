                    ...
                    <div className="flex flex-col items-center md:items-start text-center md:rtl:text-right md:ltr:text-left">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-2 relative">
                                ...
                                >
                                    <div className={`w-10 h-10 rounded-xl flex items-center justify-center transition-all duration-500 shrink-0 pointer-events-none ${expandedSocial === 'whatsapp' ? 'bg-white/10' : 'bg-white/5 border border-white/10'}`}>
                                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <div className="space-y-2 relative">
                                ...
                                >
                                    <div className={`w-10 h-10 rounded-xl flex items-center justify-center transition-all duration-500 shrink-0 pointer-events-none ${expandedSocial === 'phone' ? 'bg-white/10' : 'bg-white/5 border border-white/10'}`}>
