...
export default function FloatingContact() {
    ...
    return (
        <div className="fixed bottom-8 right-8 z-[100] flex flex-col gap-4 animate-in fade-in slide-in-from-bottom-10 duration-500">
            {/* Phone Button */}
            <a
            ...
            >
                ...
                {/* Tooltip */}
                <span className="absolute right-full mr-4 bg-[#25D366] text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none">
                    تواصل واتساب
                </span>
            </a>
        </div>
