                        ...
                        <div className="grid grid-cols-1 gap-4">
                            {contactInfo.map((info, index) => (
                                <a
                                    ...
                                    className="premium-card bg-white/70 dark:bg-white/5 backdrop-blur-xl flex items-center gap-6 p-6 group cursor-pointer border border-white/20 dark:border-white/10 hover:border-[#D4A853]/30 hover:shadow-[0_20px_40px_-15px_rgba(212,168,83,0.15)] transition-all duration-500 hover:-translate-y-1"
                                >
                                    ...
                                    <div>
                                        <h3 className="font-black text-slate-900 dark:text-white text-sm mb-1">{info.title}</h3>
                                        <p className="text-slate-500 dark:text-slate-400 font-bold text-[11px] uppercase tracking-wider">{info.value}</p>
                                    </div>
                                </a>
                            ))}
                        </div>
