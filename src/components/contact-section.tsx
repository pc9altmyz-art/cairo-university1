...
export default function ContactSection() {
    ...
    return (
        <section id="contact" className="section-padding bg-white dark:bg-[#0F172A] relative overflow-hidden scroll-mt-28">
            ...
            <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#1e3a8a]/5 rounded-full blur-[120px] -translate-y-1/2 translate-x-1/2 opacity-60 pointer-events-none hidden md:block" />
            <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-[#D4A853]/5 rounded-full blur-[120px] translate-y-1/2 -translate-x-1/2 opacity-40 pointer-events-none hidden md:block" />
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="max-w-3xl mx-auto mb-12 md:mb-16 relative flex flex-col items-center text-center">
                    ...
                    <h2 className="text-2xl md:text-5xl font-black mb-4 md:mb-6 text-slate-900 drop-shadow-sm dark:text-white animate-fade-in-up leading-tight">
                                ...
                                return (
                                    <div key={index} className="flex flex-col gap-2">
                                        ...
                                        >
                                            ...
                                            <div className="flex flex-col md:flex-row items-center gap-4 md:gap-6 relative z-10 w-full overflow-hidden">
                                                ...
                                                <div className="flex-1 overflow-hidden w-full text-center md:rtl:text-right md:ltr:text-left">
                                                ...
                                                {info.hasDropdown && (
                                                    <div className={`w-8 h-8 rounded-full flex items-center justify-center transition-all duration-500 ${isExpanded ? 'bg-[#D4A853]/20 rotate-180' : 'bg-slate-50 dark:bg-white/5 group-hover:bg-[#D4A853]/10'} shrink-0`}>
